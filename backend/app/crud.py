...
def generate_custom_palette(theme_color_hex: str, dark_mode: bool = False) -> str:
    ...
    custom_palette["--org-border-light"] = f"rgba({border_rgb[0]}, {border_rgb[1]}, {border_rgb[2]}, 0.4)"
    custom_palette["--org-border-medium"] = f"rgba({border_rgb[0]}, {border_rgb[1]}, {border_rgb[2]}, 0.4)"
